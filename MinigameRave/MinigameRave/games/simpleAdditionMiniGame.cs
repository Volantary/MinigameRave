...
namespace MinigameRave
{
    public class simpleAddition : MiniGame
    {
        ...
        public simpleAddition() : base()
        {
            ...
            option1 = new Button(textures.getTexture(0), new Vector2(0, 100));
            option1.Clicked += new EventHandler(option1_Clicked);

            option2 = new Button(textures.getTexture(0), new Vector2(0, 200));
            option2.Clicked += new EventHandler(option2_Clicked);

            option3 = new Button(textures.getTexture(0), new Vector2(0, 300));
        ...
        {
            spriteBatch.DrawString(globals.globalFont, stringToDraw, new Vector2(0, 0), Color.White); 
            option1.Draw(spriteBatch);
            spriteBatch.DrawString(globals.globalFont, firstOption.ToString(), new Vector2(0, 100), Color.Black); 
            option2.Draw(spriteBatch);
            spriteBatch.DrawString(globals.globalFont, secondOption.ToString(), new Vector2(0, 200), Color.Black); 
            option3.Draw(spriteBatch);
            spriteBatch.DrawString(globals.globalFont, thirdOption.ToString(), new Vector2(0, 300), Color.Black); 
        }
